const images = ['https://images.unsplash.com/photo-1484723091739-30a097e8f929?auto=format&fit=crop&w=500&q=60',
...
const categories = [
	{
		...
		"restaurantList": [
			...
			},
			{
				...
				"food_types": ["North Indian", "Muglai", "Continental", "Desserts", "Beverages"],
				"ratings": "4.7",
				"isExlusive": true,
...
let allRestaurantList = []
categories.forEach(category=>{
    allRestaurantList = [...allRestaurantList,...category.restaurantList]
})
 
const onlyOnSwiggy = allRestaurantList.filter(restaurant=>restaurant.isExlusive)

const categoriesObject = {
   'Only on swiggy' : {
       category : 'Only on swiggy',
       restaurantList : onlyOnSwiggy
   },
   'See All' : {category : 'See All',
    restaurantList : allRestaurantList
   },
}

categories.forEach(categoryObj=>{
    categoriesObject[categoryObj.category] = {
        category : categoryObj.category,
        restaurantList : categoryObj.restaurantList
    }
})
